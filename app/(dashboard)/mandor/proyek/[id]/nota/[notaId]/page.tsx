...
import { 
  ...
  Hash, FileText, Image as ImageIcon, Loader2, 
  Edit, Trash2, RefreshCw, AlertCircle, Plus, X, Settings,
  ExternalLink, Eye, MoreVertical
} from 'lucide-react'
...
export default function NotaDetailPage({ 
      ...
      try {
        ...
        try {
          ...
          if (milestonesResult.success && milestonesResult.data) {
            ...
            const validMilestones = milestonesResult.data.map((milestone: any) => ({
              ...milestone,
              id: milestone.id || '', // Pastikan ID tidak null
  ...
  // Handle delete bahan
  const handleDeleteBahanClick = (bahanId: string, bahanNama: string) => {
    setDeleteModal({
      isOpen: true,
      type: 'bahan',
      itemId: bahanId,
  ...
  // Handle view bahan in new tab
  const handleViewBahan = (bahanId: string) => {
    // Jika ada halaman detail bahan, bisa diarahkan kesana
    console.log('View bahan:', bahanId)
    ...
    <div className="min-h-screen bg-gray-50 p-2 md:p-6">
      <div className="max-w-7xl mx-auto">
            ...
            <div>
              ...
              <div className="flex items-center gap-2 mt-1">
                <p className="text-gray-600">
                  Nota #{nota.nomorNota || 'Tanpa Nomor'} • {nota.namaToko || 'Tanpa Nama Toko'}
                </p>
          ...
          <div className="bg-gray-50 px-5 py-3 border-b border-gray-200">
            <div className="flex justify-between items-center">
              <div className="flex items-center gap-2">
                ...
                <span className="font-medium text-gray-700">Informasi Nota</span>
              </div>
              <div className="flex items-center gap-2">
                <button
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-5">
              ...
              <div className="bg-purple-50 rounded-lg p-4 border border-purple-100">
                ...
                <p className="text-lg font-semibold text-gray-900">
                  {nota.tanggalBelanja ? new Date(nota.tanggalBelanja).toLocaleDateString('id-ID', {
                    day: 'numeric',
                    month: 'short',
                    year: 'numeric'
                  }) : '-'}
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mt-6 pt-6 border-t border-gray-200">
              <div>
                ...
                <p className="font-medium text-gray-900">
                  {nota.createdAt ? new Date(nota.createdAt).toLocaleDateString('id-ID', {
                    day: 'numeric',
                    month: 'long',
                    year: 'numeric',
                    hour: '2-digit',
          ...
          <div className="bg-gray-50 px-5 py-4 border-b border-gray-200">
            <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <h2 className="text-xl font-semibold text-gray-900">Bahan Harian</h2>
        ...
        <DeleteConfirmModal
          ...
          title={`Konfirmasi Hapus ${deleteModal.type === 'nota' ? 'Nota' : 'Bahan'}`}
          description={`Apakah Anda yakin ingin menghapus ${deleteModal.type === 'nota' ? 'nota ini' : 'bahan ini'}?`}
